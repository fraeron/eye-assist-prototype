...
// hatdoogggggggggggggggggggggggggggggggggggggggggggggggg
$menuItems = [
    [
        "menuTitle" => "Dashboard",
        "icon" => "fas fa-tachometer-alt",
        "pages" => [
            ["title" => "Home", "url" => "https://localhost/eaprototype/admin/dashboard.php"]
        ],
    ],
    [
        "menuTitle" => "Settings",
        "icon" => "fas fa-cog",
        "pages" => [
            ["title" => "Profile", "url" => "https://localhost/eaprototype/admin/profile.php"]
        ],
    ]
];
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://localhost/eaprototype/admin/dashboard.php" class="nav-link">Home</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:rgb(52, 47, 56)">
            <a href="./" class="brand-link">
                <img src="https://localhost/eaprototype/admin/src/images/logo.png" alt="Logo" class="brand-image img-circle bg-white">
                <span class="brand-text font-weight-light">
                    EA Admin Panel
                </span>
            </a>
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3" style="border-bottom: none">
                    <a href="./profile.php" class="d-flex">
                        <div class="image">
                            <img src="https://localhost/eaprototype/admin/src/images/profile_picture/default.png" class="img-circle elevation-2 bg-white" alt="User Image">
                        </div>
                        <div class="info">
